  ...
  void initState() {
    ...
    list = [
      ...
      Frases(
          ...
          "- PAULO FREIRE"),
      Frases("Você não pode ensinar nada a ninguém, mas pode ajudar as pessoas a descobrirem por si mesmas.", "- OSIEL BASÍLIO"),
      Frases("Construímos muros demais e pontes de menos.", "- ISAAC NEWTON"),
      Frases("O professor deve adotar o papel de facilitador, não de provedor de conteúdo.", "- LEV VYGOTSKY"),

...
Widget aristoteles(BuildContext context) {
  return Filosofos(
    ...
    map: {
      '1': Frases('O sábio nunca diz tudo o que pensa, mas pensa sobre tudo que diz.', 'dwawadkmwadk'),
      '2': Frases('O homem solitário é uma besta ou um deus.', 'Aristóteles'),
      '3': Frases('O que é um amigo? Uma única alma habitando dois corpos.', 'Aristóteles'),
      '4': Frases('Sócrates é meu amigo, mas sou mais amigo da verdade.', 'Aristóteles'),
      '5': Frases('A cultura é o melhor conforto para a velhice.', 'Aristóteles'),
      '6' : Frases('O menor desvio inicial da verdade multiplica-se ao infinito à medida que avança.', 'Aristóteles')
    },
  );
}
